...
$_['entry_address_format']    = 'Formato dirección
$_['entry_postcode_required'] = 'Código postal obligatorio';
$_['entry_status']            = 'Estado';

// Help
$_['help_address_format']     = 'Nombre = {firstname}<br />Apellido/s = {lastname}<br />Compañía = {company}<br />Dirección 1 = {address_1}<br />Dirección 2 = {address_2}<br />Ciudad = {city}<br />Código postal = {postcode}<br />Zona = {zone}<br />Código zona = {zone_code}<br />País = {country}';
